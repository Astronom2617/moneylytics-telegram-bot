...
TRANSLATIONS = {
    "en": {
        ...
        "budget.daily_warn": "🔶 Daily budget used at {percent}%: {total} {currency} / {limit} {currency}",
        "budget.weekly_warn": "🔶 Weekly budget used at {percent}%: {total} {currency} / {limit} {currency}",
        "budget.daily_exceeds_weekly": "❌ Daily budget cannot exceed weekly budget ({weekly}).",
        "budget.weekly_less_than_daily": "❌ Weekly budget cannot be less than daily budget ({daily}).",
        "feedback.prompt": "🐛 Describe the bug or issue. What happened and what did you expect?",
        "feedback.thanks": "✅ Thanks! Your report has been saved. I'll look into it.",
        "feedback.cancel": "❌ Cancelled.",
        ...
        "admin.menu_title": "🛠 Admin panel",
        "admin.feedbacks_btn": "📬 Feedbacks ({count} new)",
        "admin.broadcast_btn": "📢 Broadcast",
        "admin.stats_btn": "📊 Stats",
        "admin.refresh": "Refresh",
        "admin.new_feedback": "📬 <b>New feedback</b> from {name}\n\n<i>{text}</i>\n\nUnread: <b>{count}</b>\nOpen: /admin",
        "admin.feedbacks_title": "📋 <b>Feedbacks</b> (page {page}):",
        "admin.no_reports": "No reports.",
        "admin.read_all_done": "✅ All marked as read.",
        "admin.back": "🔙 Menu",
        "admin.prev": "← Back",
        "admin.next": "Next →",
        "admin.mark_all_read": "✅ Mark all as read",
        "admin.report_title": "📬 <b>Feedback #{id}</b>\n👤 {name} · {date}\n\n{text}",
        "admin.report_not_found": "Report not found.",
        "admin.broadcast_prompt": "✍️ Enter broadcast text.\n\nHTML supported: <b>bold</b>, <i>italic</i>\n\nSend /cancel to abort.",
        "admin.broadcast_preview": "📢 <b>Broadcast preview:</b>\n\n{text}\n\n─────────────────\nRecipients: <b>{count}</b>",
        "admin.broadcast_send": "✅ Send to all",
        "admin.broadcast_cancel_btn": "❌ Cancel",
        "admin.broadcast_done": "✅ Broadcast complete.\nSent: <b>{sent}</b>\nFailed: <b>{failed}</b>",
    ...
    "ru": {
        ...
        "budget.daily_warn": "🔶 Дневной бюджет использован на {percent}%: {total} {currency} / {limit} {currency}",
        "budget.weekly_warn": "🔶 Недельный бюджет использован на {percent}%: {total} {currency} / {limit} {currency}",
        "budget.daily_exceeds_weekly": "❌ Дневной бюджет не может превышать недельный ({weekly}).",
        "budget.weekly_less_than_daily": "❌ Недельный бюджет не может быть меньше дневного ({daily}).",
        "feedback.prompt": "🐛 Опиши баг или проблему. Что произошло и что ожидалось?",
        "feedback.thanks": "✅ Спасибо! Репорт сохранён. Я разберусь.",
        "feedback.cancel": "❌ Отменено.",
        ...
        "admin.menu_title": "🛠 Админ панель",
        "admin.feedbacks_btn": "📬 Фидбеки ({count} новых)",
        "admin.broadcast_btn": "📢 Рассылка",
        "admin.stats_btn": "📊 Статистика",
        "admin.refresh": "Обновить",
        "admin.new_feedback": "📬 <b>Новый фидбек</b> от {name}\n\n<i>{text}</i>\n\nНепрочитанных: <b>{count}</b>\nОткрой: /admin",
        "admin.feedbacks_title": "📋 <b>Фидбеки</b> (стр. {page}):",
        "admin.no_reports": "Репортов нет.",
        "admin.read_all_done": "✅ Все помечены прочитанными.",
        "admin.back": "🔙 Меню",
        "admin.prev": "← Назад",
        "admin.next": "Далее →",
        "admin.mark_all_read": "✅ Отметить все прочитанными",
        "admin.report_title": "📬 <b>Feedback #{id}</b>\n👤 {name} · {date}\n\n{text}",
        "admin.report_not_found": "Репорт не найден.",
        "admin.broadcast_prompt": "✍️ Введи текст рассылки.\n\nПоддерживается HTML: <b>жирный</b>, <i>курсив</i>\n\nОтправь /cancel для отмены.",
        "admin.broadcast_preview": "📢 <b>Превью рассылки:</b>\n\n{text}\n\n─────────────────\nПолучателей: <b>{count}</b>",
        "admin.broadcast_send": "✅ Отправить всем",
        "admin.broadcast_cancel_btn": "❌ Отменить",
    ...
    "uk": {
        ...
        "budget.daily_warn": "🔶 Денний бюджет використано на {percent}%: {total} {currency} / {limit} {currency}",
        "budget.weekly_warn": "🔶 Тижневий бюджет використано на {percent}%: {total} {currency} / {limit} {currency}",
        "budget.daily_exceeds_weekly": "❌ Денний бюджет не може перевищувати тижневий ({weekly}).",
        "budget.weekly_less_than_daily": "❌ Тижневий бюджет не може бути меншим за денний ({daily}).",
        "feedback.prompt": "🐛 Опиши баг або проблему. Що сталося і що очікувалось?",
        "feedback.thanks": "✅ Дякую! Репорт збережено. Розберусь.",
        "feedback.cancel": "❌ Скасовано.",
        "feedback.button": "🐛 Зворотній зв'язок",
        ...
        "admin.menu_title": "🛠 Адмін панель",
        "admin.feedbacks_btn": "📬 Фідбеки ({count} нових)",
        "admin.broadcast_btn": "📢 Розсилка",
        "admin.stats_btn": "📊 Статистика",
        "admin.refresh": "Оновити",
        "admin.new_feedback": "📬 <b>Новий фідбек</b> від {name}\n\n<i>{text}</i>\n\nНепрочитаних: <b>{count}</b>\nВідкрий: /admin",
        "admin.feedbacks_title": "📋 <b>Фідбеки</b> (стор. {page}):",
        "admin.no_reports": "Репортів немає.",
        "admin.read_all_done": "✅ Всі позначені прочитаними.",
        "admin.back": "🔙 Меню",
        "admin.prev": "← Назад",
        "admin.next": "Далі →",
        "admin.mark_all_read": "✅ Позначити всі прочитаними",
        "admin.report_title": "📬 <b>Feedback #{id}</b>\n👤 {name} · {date}\n\n{text}",
        "admin.report_not_found": "Репорт не знайдено.",
        "admin.broadcast_prompt": "✍️ Введи текст розсилки.\n\nПідтримується HTML: <b>жирний</b>, <i>курсив</i>\n\nНадішли /cancel для скасування.",
        "admin.broadcast_preview": "📢 <b>Попередній перегляд:</b>\n\n{text}\n\n─────────────────\nОтримувачів: <b>{count}</b>",
        "admin.broadcast_send": "✅ Надіслати всім",
        "admin.broadcast_cancel_btn": "❌ Скасувати",
        "admin.broadcast_done": "✅ Розсилку завершено.\nНадіслано: <b>{sent}</b>\nНе доставлено: <b>{failed}</b>",
        "admin.broadcast_cancelled": "❌ Розсилку скасовано.",
        "months": {
