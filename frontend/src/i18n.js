const dict = {
  en: {
    ...
    'subs.emptyHint':     'Track recurring charges like Netflix or your gym.',
    'subs.add':           'Add subscription',
    'subs.edit':          'Edit subscription',
    'subs.name':          'Name',
    'subs.namePlaceholder': 'e.g. Netflix',
    'subs.amount':        'Amount',
    'subs.period':        'Repeats',
    'subs.monthly':       'Monthly',
    'subs.weekly':        'Weekly',
    'subs.nextDue':       'Next charge',
    'subs.totalMonthly':  'Per month',
    'subs.active':        'Active',
    'subs.paused':        'Paused',
    'subs.pause':         'Pause',
    'subs.resume':        'Resume',
  ...
  ru: {
    ...
    'subs.empty':         'Пока нет подписок',
    'subs.emptyHint':     'Отслеживай регулярные списания — Netflix, спортзал и т. д.',
    'subs.add':           'Добавить подписку',
    'subs.edit':          'Редактировать подписку',
    'subs.name':          'Название',
    'subs.namePlaceholder': 'напр. Netflix',
    'subs.amount':        'Сумма',
    'subs.period':        'Повторяется',
    'subs.monthly':       'Ежемесячно',
    'subs.weekly':        'Еженедельно',
    'subs.nextDue':       'Следующее списание',
    'subs.totalMonthly':  'В месяц',
    'subs.active':        'Активна',
    'subs.paused':        'На паузе',
    'subs.pause':         'Пауза',
    'subs.resume':        'Возобновить',
    'subs.delete':        'Удалить подписку',
    'subs.confirmDelete': 'Удалить эту подписку?',
    'subs.save':          'Сохранить',
    'subs.create':        'Создать',
  ...
  uk: {
    ...
    'subs.empty':         'Поки немає підписок',
    'subs.emptyHint':     'Стеж за регулярними списаннями — Netflix, спортзал тощо.',
    'subs.add':           'Додати підписку',
    'subs.edit':          'Редагувати підписку',
    'subs.name':          'Назва',
    'subs.namePlaceholder': 'напр. Netflix',
    'subs.amount':        'Сума',
    'subs.period':        'Повторюється',
    'subs.monthly':       'Щомісяця',
    'subs.weekly':        'Щотижня',
    'subs.nextDue':       'Наступне списання',
    'subs.totalMonthly':  'На місяць',
    'subs.active':        'Активна',
    'subs.paused':        'На паузі',
    'subs.pause':         'Пауза',
    'subs.resume':        'Відновити',
    'subs.delete':        'Видалити підписку',
    'subs.confirmDelete': 'Видалити цю підписку?',
    'subs.save':          'Зберегти',
    'subs.create':        'Створити',
